...
import { Box, Flex, Heading, Image, Button, VStack, useToast } from "@chakra-ui/react";
...
export default function Mint() {
    ...
    const contract = new ethers.Contract(stakingNFTAddress, stakingNFTABI, ethers.getDefaultProvider());
    useContractEvent({
        address: stakingNFTAddress,
        abi: stakingNFTABI,
        eventName: "Transfer",
            ...
            <Container>
                ...
                >
                    ...
                    {isMinted && mintData && (
                        <VStack>
                            <Box>
                                <a href={`https://testnet.tomoscan.io/tx/${mintData?.hash}`} target="_blank" rel="noopener noreferrer" style={{ color: 'yellow', fontSize: '20px' }}>
                            ...
                            {nftMetadata && (
                                <img src={image} alt="IPFS Image" style={{ width: '600px', height: '600px' }}/>
                            )}
                            </Box>
                        </VStack>
                    )}
